...
import data
import pickle
from config.config import set_train_config, set_test_config
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # TODO:
        parser.add_argument('--remove_hard_imgs', action='store_true', 
                            help='ignore gray training imgs')
        parser.add_argument('--remove_img_txt_path', type=str, default='',
                            help='txt file of hard img names')
        parser.add_argument('--brightness', type=tuple, default=(1,1), 
                            help='training image brightness augment. Tuple of float (min, max) in range(0,inf)')
        parser.add_argument('--contrast', type=tuple, default=(1,1), 
                            help='training image contrast augment. Tuple of float (min, max) in range(0,inf)')
        parser.add_argument('--saturation', type=tuple, default=(1,1), 
                            help='training image saturation augment. Tuple of float (min, max) in range(0,inf)')
        # parser.add_argument('--seed', type=int, default=0, 
        #                     help='the global seed for test')
        
        parser.add_argument('--encoder_control_strategy', default=0, type=int,
                            help='the type to use encoder brach')
        parser.add_argument('--decoder_control_strategy', default=0, type=int,
                            help='the type to use decoder brach')
        parser.add_argument('--encoder_augument_strategy', default=0, type=int,
                            help='the type to use encoder augument')
        parser.add_argument('--decoder_augument_strategy', default=0, type=int,
                            help='the type to use decoder augument')
        parser.add_argument('--gn_norm_strategy', default=3, type=int,
                            help='')
        parser.add_argument('--norm_before_noise', default=0, type=int,
                            help='')
        parser.add_argument('--norm_before_conv', default=0, type=int,
                            help='')
        parser.add_argument('--without_adain', default=0, type=int,
                            help='')
        parser.add_argument('--use_vit', default=0, type=int,
                            help='')
        parser.add_argument('--use_VQ', default=0, type=int,
                            help='')
        parser.add_argument('--use_VQ_res', default=0, type=int,
                            help='')
        parser.add_argument('--use_sean', default=0, type=int,
                            help='')
        parser.add_argument('--sean_dim', default=256, type=int,
                            help='')
        parser.add_argument('--use_EMA', default=0, type=int,
                            help='')
        parser.add_argument('--which_origin_epoch', default="299", type=str,
                            help='which epoch to style finetune')
        parser.add_argument('--frozen_type', default=0, type=int,
                            help='finetune frozen the G and D')
        parser.add_argument('--align_type', default=0, type=int,
                            help='reduce the layer of D')
        parser.add_argument('--inception_type', default=0, type=int,
                            help='if 1 use inception loss')
        parser.add_argument('--add_generate', default=0, type=int,
                            help='if 1 use inception loss')
        # for displays
        ...
        parser.add_argument('--no_instance',default=True, action='store_true',
        ...
        parser.add_argument('--use_mask_encoder', action='store_true', 
                            help='enable training with an image encoder to encode mask.')
        parser.add_argument('--add_noise', action='store_true', default=False,
                            help='add noise')
        parser.add_argument('--use_seg_noise', action='store_true', 
                            help='use noise in spade seg map.')
        parser.add_argument('--use_seg_noise_kernel', type=int, default=1, 
                            help='use noise in spade seg map, conv kernel.')
    ...
    def gather_options(self):
        ...
        # set default args for train/test
        if self.isTrain:
            parser = set_train_config(parser) # TODO:change
        else:
            parser = set_test_config(parser) # TODO:change
