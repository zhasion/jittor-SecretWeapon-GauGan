...
def merge_ckpt(path, ckpts_to_merge):
    ckpt_root_path = path
    save_path = os.path.join("checkpoints/merge/", 'avg_' + '_'.join(ckpts_to_merge) + '_net')
...
if __name__ == "__main__":
    ...
    merge_path_root = "checkpoints/pg_all_out"
    ckpts_to_merge = ["417", "425"]
    merge_ckpt(merge_path_root, ckpts_to_merge)